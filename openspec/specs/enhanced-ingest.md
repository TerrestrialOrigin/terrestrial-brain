...
Enhanced capabilities for the `ingest_note` and `capture_thought` tools, including note snapshots, extractor pipeline integration, and backwards-compatible reference helpers.
