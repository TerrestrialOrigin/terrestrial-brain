...
Codifies the cross-repository seam conventions the data layer follows: narrow role-scoped repository interfaces, a single shared query-result wrapping helper, schema-typed update payloads, and typed RPC row results.
