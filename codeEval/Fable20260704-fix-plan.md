...
- [x] 26. Naming & dead-code sweep (`feature/NamingAndDeadCodeSweep`)
- [x] 27. Plugin packaging hygiene (`feature/PluginConfigHygiene`)
- [x] 28. Repo & schema tidy-up (`feature/RepoAndSchemaTidy`)
